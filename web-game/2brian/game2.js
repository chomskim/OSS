...
function Sprite(sprite, pos) {
  ...
  this.contains = function (p1) {
    return (
      this.position.x - this.center.x < p1.x &&
      p1.x < this.position.x + this.center.x &&
      this.position.y - this.center.y < p1.y &&
      p1.y < this.position.y + this.center.y
    )
  }
  this.draw = function () {
...
function Button(color) {
  ...
  this.contains = function (p1) {
    return (
      ...
      p1.x < this.position.x + this.size.x &&
      this.position.y < p1.y &&
      p1.y < this.position.y + this.size.y
    )
  }
}
